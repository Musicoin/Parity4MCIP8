...
pub struct EthashParams {
	...
	/// MCIP-8 is amazing
	#[serde(rename="mcip8Transition")]
	pub mcip10_transition: Option<Uint>,
	/// See main EthashParams docs.
	#[serde(rename="mcip8MinerReward")]
	pub mcip10_miner_reward: Option<Uint>,
	...
	fn ethash_deserialization() {
		...
		assert_eq!(deserialized, Ethash {
			params: EthashParams{
				...
				mcip8_transition: None,
				mcip8_miner_reward: None,
				mcip10_transition: None,
				mcip10_miner_reward: None,
